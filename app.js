...
var taskInput=document.querySelector(".task__input-add");//Add a new task.
...
var createNewTaskElement=function(taskString){
    ...
    label.className="task__label task__part";
    ...
    editInput.type="text";
    editInput.className="task__input-text task__part";
    ...
    listItem.className="task__item task__item-incomplete";
